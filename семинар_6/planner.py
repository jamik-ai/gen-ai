...
ПРАВИЛА:
1. Если вопрос требует арифметики над числами из других подвопросов
   (разность, отношение, произведение, сумма и т.п.) — ОБЯЗАТЕЛЬНО
   добавь отдельный подвопрос с инструментом calculate и depends_on
   на те подвопросы, чьи числа нужны. Не считай в уме.
