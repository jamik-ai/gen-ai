"""
JSON-схемы инструментов для Tool Use API (OpenAI-совместимого).
"""
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Возвращает значения в обоих периодах, абсолютный сдвиг (delta) "
                "и отношение (ratio = b/a). "
                "Использовать, когда вопрос содержит «вырос», «упал», «во сколько раз», "
                "«сравни X тогда и сейчас»."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "metric": {
                        ...
                        "description": (
                            "Метрика: key_rate — ключевая ставка; "
                            "fx_USD/fx_EUR/fx_CNY — курс к рублю; "
